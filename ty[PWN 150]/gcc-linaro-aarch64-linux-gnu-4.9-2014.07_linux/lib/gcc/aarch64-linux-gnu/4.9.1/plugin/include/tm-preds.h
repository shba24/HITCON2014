/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/cbuild/slaves/oorts/crosstool-ng/builds/aarch64-linux-gnu-linux/.build/src/gcc-linaro-4.9-2014.06/gcc/config/aarch64/aarch64.md'.  */
